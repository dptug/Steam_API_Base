...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamUser_v023\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamUtils_v010\r\n");
...
S_API ISteamUGC* S_CALLTYPE SteamAPI_SteamUGC_v018()
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamUGC_v018\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamGameServerUtils_v010\r\n");
...
S_API ISteamUGC* S_CALLTYPE SteamAPI_SteamGameServerUGC_v018()
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamGameServerUGC_v018\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamGameServerNetworkingMessages_SteamAPI_v002\r\n");
	return SteamInternal_FindOrCreateGameServerInterface(hUserServer, STEAMNETWORKINGMESSAGES_INTERFACE_VERSION);
}

S_API void* S_CALLTYPE SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v012()
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v012\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamGameServer_v015\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamRemoteStorage_v016\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamRemotePlay_v002\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamNetworkingSockets_SteamAPI_v012\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamNetworkingUtils_SteamAPI_v004\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamNetworkingMessages_SteamAPI_v002\r\n");
	return SteamInternal_FindOrCreateUserInterface(hUser, STEAMNETWORKINGMESSAGES_INTERFACE_VERSION);
}
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamInput_v006\r\n");
...
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamController_v008\r\n");
...
S_API ISteamVideo* S_CALLTYPE SteamAPI_SteamVideo_v004()
{
	_cprintf_s("[Steam_API_Base] SteamAPI_SteamVideo_v004\r\n");
