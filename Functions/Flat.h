...
S_API void S_CALLTYPE SteamAPI_SteamNetworkingIdentity_SetStadiaID(SteamNetworkingIdentity* self, uint64 StadiaID)
{
	return self->SetStadiaID(StadiaID);
}

S_API uint64 S_CALLTYPE SteamAPI_SteamNetworkingIdentity_GetStadiaID(SteamNetworkingIdentity* self)
{
	return self->GetStadiaID();
}
...
S_API int S_CALLTYPE SteamAPI_ISteamUser_InitiateGameConnection(intptr_t instancePtr, void* pAuthBlob, int cbMaxAuthBlob, class CSteamID steamIDGameServer, uint32 unIPServer, uint16 usPortServer, bool bSecure)
{
	...
	return GetInterfacePointers.SteamUser()->InitiateGameConnection_DEPRECATED(pAuthBlob, cbMaxAuthBlob, steamIDGameServer, unIPServer, usPortServer, bSecure);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamUser_TerminateGameConnection(intptr_t instancePtr, uint32 unIPServer, uint16 usPortServer)
{
	...
	return GetInterfacePointers.SteamUser()->TerminateGameConnection_DEPRECATED(unIPServer, usPortServer);
}
...
S_API HAuthTicket S_CALLTYPE SteamAPI_ISteamUser_GetAuthSessionTicket(intptr_t instancePtr, void* pTicket, int cbMaxTicket, uint32* pcbTicket, const SteamNetworkingIdentity* pSteamNetworkingIdentity)
{
	...
	return GetInterfacePointers.SteamUser()->GetAuthSessionTicket(pTicket, cbMaxTicket, pcbTicket, pSteamNetworkingIdentity);
}
...
S_API HAuthTicket S_CALLTYPE SteamAPI_ISteamUser_GetAuthTicketForWebApi(intptr_t instancePtr, const char* pchIdentity)
{
	...
	return GetInterfacePointers.SteamUser()->GetAuthTicketForWebApi(pchIdentity);
}
...
S_API void SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialogConnectString(intptr_t instancePtr, const char* pchConnectString)
{
	...
	return GetInterfacePointers.SteamFriends()->ActivateGameOverlayInviteDialogConnectString(pchConnectString);
}
...
S_API SteamAPICall_t SteamAPI_ISteamFriends_RequestEquippedProfileItems(intptr_t instancePtr, CSteamID steamID)
{
	...
	return GetInterfacePointers.SteamFriends()->RequestEquippedProfileItems(steamID);
}
...
S_API bool SteamAPI_ISteamFriends_BHasEquippedProfileItem(intptr_t instancePtr, CSteamID steamID, ECommunityProfileItemType itemType)
{
	...
	return GetInterfacePointers.SteamFriends()->BHasEquippedProfileItem(steamID, itemType);
}
...
S_API const char* SteamAPI_ISteamFriends_GetProfileItemPropertyString(intptr_t instancePtr, CSteamID steamID, ECommunityProfileItemType itemType, ECommunityProfileItemProperty prop)
{
	...
	return GetInterfacePointers.SteamFriends()->GetProfileItemPropertyString(steamID, itemType, prop);
}
...
S_API uint32 SteamAPI_ISteamFriends_GetProfileItemPropertyUint(intptr_t instancePtr, CSteamID steamID, ECommunityProfileItemType itemType, ECommunityProfileItemProperty prop)
{
	...
	return GetInterfacePointers.SteamFriends()->GetProfileItemPropertyUint(steamID, itemType, prop);
}
...
S_API int S_CALLTYPE SteamAPI_ISteamUtils_FilterText(intptr_t instancePtr, ETextFilteringContext eContext, CSteamID sourceSteamID, const char* pchInputMessage, char* pchOutFilteredText, uint32 nByteSizeOutFilteredText)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamGameServerUtils() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamGameServerUtils()->FilterText(eContext, sourceSteamID, pchInputMessage, pchOutFilteredText, nByteSizeOutFilteredText);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUtils()->FilterText(eContext, sourceSteamID, pchInputMessage, pchOutFilteredText, nByteSizeOutFilteredText);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUtils_IsSteamRunningOnSteamDeck(intptr_t instancePtr)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamGameServerUtils() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamGameServerUtils()->IsSteamRunningOnSteamDeck();
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUtils()->IsSteamRunningOnSteamDeck();
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUtils_ShowFloatingGamepadTextInput(intptr_t instancePtr, EFloatingGamepadTextInputMode eKeyboardMode, int nTextFieldXPosition, int nTextFieldYPosition, int nTextFieldWidth, int nTextFieldHeight)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamGameServerUtils() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamGameServerUtils()->ShowFloatingGamepadTextInput(eKeyboardMode, nTextFieldXPosition, nTextFieldYPosition, nTextFieldWidth, nTextFieldHeight);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUtils()->ShowFloatingGamepadTextInput(eKeyboardMode, nTextFieldXPosition, nTextFieldYPosition, nTextFieldWidth, nTextFieldHeight);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamUtils_SetGameLauncherMode(intptr_t instancePtr, bool bLauncherMode)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamGameServerUtils() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamGameServerUtils()->SetGameLauncherMode(bLauncherMode);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUtils()->SetGameLauncherMode(bLauncherMode);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUtils_DismissFloatingGamepadTextInput(intptr_t instancePtr)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamGameServerUtils() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamGameServerUtils()->DismissFloatingGamepadTextInput();
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUtils()->DismissFloatingGamepadTextInput();
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUtils_DismissGamepadTextInput(intptr_t instancePtr)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamGameServerUtils() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamGameServerUtils()->DismissGamepadTextInput();
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUtils()->DismissGamepadTextInput();
}
...
S_API int32 S_CALLTYPE SteamAPI_ISteamRemoteStorage_GetLocalFileChangeCount(intptr_t instancePtr)
{
	...
	return GetInterfacePointers.SteamRemoteStorage()->GetLocalFileChangeCount();
}
...
S_API const char* S_CALLTYPE SteamAPI_ISteamRemoteStorage_GetLocalFileChange(intptr_t instancePtr, int iFile, ERemoteStorageLocalFileChange* pEChangeType, ERemoteStorageFilePathType* pEFilePathType)
{
	...
	return GetInterfacePointers.SteamRemoteStorage()->GetLocalFileChange(iFile, pEChangeType, pEFilePathType);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamRemoteStorage_BeginFileWriteBatch(intptr_t instancePtr)
{
	...
	return GetInterfacePointers.SteamRemoteStorage()->BeginFileWriteBatch();
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamRemoteStorage_EndFileWriteBatch(intptr_t instancePtr)
{
	...
	return GetInterfacePointers.SteamRemoteStorage()->EndFileWriteBatch();
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamApps_SetDlcContext(intptr_t instancePtr, AppId_t nAppID)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamApps() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamApps()->SetDlcContext(nAppID);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamApps()->SetDlcContext(nAppID);
}
...
S_API EResult S_CALLTYPE SteamAPI_ISteamNetworkingMessages_SendMessageToUser(intptr_t instancePtr, const SteamNetworkingIdentity& identityRemote, const void* pubData, uint32 cubData, int nSendFlags, int nRemoteChannel)
{
	if (InitGameServerPointers == true)
	{
		void* pInterfaceAddress = SteamInternal_FindOrCreateGameServerInterface(hUserServer, STEAMNETWORKINGMESSAGES_INTERFACE_VERSION);

		if (instancePtr == (intptr_t)pInterfaceAddress || InitClientPointers == false)
		{
	...
	void* pInterfaceAddress = SteamInternal_FindOrCreateUserInterface(hUser, STEAMNETWORKINGMESSAGES_INTERFACE_VERSION);
...
S_API HSteamListenSocket S_CALLTYPE SteamAPI_ISteamNetworkingSockets_CreateListenSocketIP(intptr_t instancePtr, const SteamNetworkingIPAddr& localAddress, int nOptions, const SteamNetworkingConfigValue_t* pOptions)
{
	if (InitGameServerPointers == true)
	{
		void* pInterfaceAddress = SteamInternal_FindOrCreateGameServerInterface(hUserServer, STEAMNETWORKINGSOCKETS_INTERFACE_VERSION);
	...
	void* pInterfaceAddress = SteamInternal_FindOrCreateUserInterface(hUser, STEAMNETWORKINGSOCKETS_INTERFACE_VERSION);
...
/*S_API bool S_CALLTYPE SteamAPI_ISteamNetworkingSockets_GetQuickConnectionStatus(intptr_t instancePtr, HSteamNetConnection hConn, SteamNetworkingQuickConnectionStatus* pStats) //Removed in 1.53
{
	if (InitGameServerPointers == true)
	{
		void* pInterfaceAddress = SteamInternal_FindOrCreateGameServerInterface(hUserServer, STEAMNETWORKINGSOCKETS_INTERFACE_VERSION);
		...
		if (instancePtr == (intptr_t)pInterfaceAddress || InitClientPointers == false)
		{
			...
			return pSteamNetworkingSockets->GetQuickConnectionStatus(hConn, pStats);
		}
	}
...
S_API SteamNetworkingMessage_t* S_CALLTYPE SteamAPI_ISteamNetworkingUtils_AllocateMessage(intptr_t instancePtr, int cbAllocateBuffer)
{
	if (InitGameServerPointers == true)
	{
		void* pInterfaceAddress = SteamInternal_FindOrCreateGameServerInterface(hUserServer, STEAMNETWORKINGUTILS_INTERFACE_VERSION);
	...
	void* pInterfaceAddress = SteamInternal_FindOrCreateUserInterface(hUser, STEAMNETWORKINGUTILS_INTERFACE_VERSION);
...
/*S_API ESteamNetworkingConfigValue S_CALLTYPE SteamAPI_ISteamNetworkingUtils_GetFirstConfigValue(intptr_t instancePtr) //Removed in 1.53
{
	if (InitGameServerPointers == true)
	{
		void* pInterfaceAddress = SteamInternal_FindOrCreateGameServerInterface(hUserServer, STEAMNETWORKINGUTILS_INTERFACE_VERSION);
		...
		if (instancePtr == (intptr_t)pInterfaceAddress || InitClientPointers == false)
		{
			...
			return pSteamNetworkingUtils->GetFirstConfigValue();
		}
	}
...
S_API bool S_CALLTYPE SteamAPI_ISteamInput_Init(intptr_t instancePtr, bool bExplicitlyCallRunFrame)
{
	...
	return GetInterfacePointers.SteamInput()->Init(bExplicitlyCallRunFrame);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamInput_SetInputActionManifestFilePath(intptr_t instancePtr, const char* pchInputActionManifestAbsolutePath)
{
	...
	return GetInterfacePointers.SteamInput()->SetInputActionManifestFilePath(pchInputActionManifestAbsolutePath);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamInput_RunFrame(intptr_t instancePtr, bool bReservedValue)
{
	...
	return GetInterfacePointers.SteamInput()->RunFrame(bReservedValue);
}
...
S_API bool SteamAPI_ISteamInput_BWaitForData(intptr_t instancePtr, bool bWaitForever, uint32 unTimeout)
{
	...
	return GetInterfacePointers.SteamInput()->BWaitForData(bWaitForever, unTimeout);
}
...
S_API bool SteamAPI_ISteamInput_BNewDataAvailable(intptr_t instancePtr)
{
	...
	return GetInterfacePointers.SteamInput()->BNewDataAvailable();
}
...
S_API void S_CALLTYPE SteamAPI_ISteamInput_EnableDeviceCallbacks(intptr_t instancePtr)
{
	...
	return GetInterfacePointers.SteamInput()->EnableDeviceCallbacks();
}
...
S_API void S_CALLTYPE SteamAPI_ISteamInput_EnableActionEventCallbacks(intptr_t instancePtr, SteamInputActionEventCallbackPointer pCallback)
{
	...
	return GetInterfacePointers.SteamInput()->EnableActionEventCallbacks(pCallback);
}
...
S_API const char* S_CALLTYPE SteamAPI_ISteamInput_GetStringForDigitalActionName(intptr_t instancePtr, InputDigitalActionHandle_t eActionHandle)
{
	...
	return GetInterfacePointers.SteamInput()->GetStringForDigitalActionName(eActionHandle);
}
...
S_API const char* S_CALLTYPE SteamAPI_ISteamInput_GetGlyphPNGForActionOrigin(intptr_t instancePtr, EInputActionOrigin eOrigin, ESteamInputGlyphSize eSize, uint32 unFlags)
{
	...
	return GetInterfacePointers.SteamInput()->GetGlyphPNGForActionOrigin(eOrigin, eSize, unFlags);
}
...
S_API const char* S_CALLTYPE SteamAPI_ISteamInput_GetGlyphSVGForActionOrigin(intptr_t instancePtr, EInputActionOrigin eOrigin, uint32 unFlags)
{
	...
	return GetInterfacePointers.SteamInput()->GetGlyphSVGForActionOrigin(eOrigin, unFlags);
}
...
S_API const char* S_CALLTYPE SteamAPI_ISteamInput_GetGlyphForActionOrigin_Legacy(intptr_t instancePtr, EInputActionOrigin eOrigin)
{
	...
	return GetInterfacePointers.SteamInput()->GetGlyphForActionOrigin_Legacy(eOrigin);
}
...
S_API const char* S_CALLTYPE SteamAPI_ISteamInput_GetStringForAnalogActionName(intptr_t instancePtr, InputAnalogActionHandle_t eActionHandle)
{
	...
	return GetInterfacePointers.SteamInput()->GetStringForAnalogActionName(eActionHandle);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamInput_TriggerVibrationExtended(intptr_t instancePtr, InputHandle_t inputHandle, unsigned short usLeftSpeed, unsigned short usRightSpeed, unsigned short usLeftTriggerSpeed, unsigned short usRightTriggerSpeed)
{
	...
	return GetInterfacePointers.SteamInput()->TriggerVibrationExtended(inputHandle, usLeftSpeed, usRightSpeed, usLeftTriggerSpeed, usRightTriggerSpeed);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamInput_TriggerSimpleHapticEvent(intptr_t instancePtr, InputHandle_t inputHandle, EControllerHapticLocation eHapticLocation, uint8 nIntensity, char nGainDB, uint8 nOtherIntensity, char nOtherGainDB)
{
	...
	return GetInterfacePointers.SteamInput()->TriggerSimpleHapticEvent(inputHandle, eHapticLocation, nIntensity, nGainDB, nOtherIntensity, nOtherGainDB);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamInput_Legacy_TriggerHapticPulse(intptr_t instancePtr, InputHandle_t inputHandle, ESteamControllerPad eTargetPad, unsigned short usDurationMicroSec)
{
	...
	return GetInterfacePointers.SteamInput()->Legacy_TriggerHapticPulse(inputHandle, eTargetPad, usDurationMicroSec);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamInput_Legacy_TriggerRepeatedHapticPulse(intptr_t instancePtr, InputHandle_t inputHandle, ESteamControllerPad eTargetPad, unsigned short usDurationMicroSec, unsigned short usOffMicroSec, unsigned short unRepeat, unsigned int nFlags)
{
	...
	return GetInterfacePointers.SteamInput()->Legacy_TriggerRepeatedHapticPulse(inputHandle, eTargetPad, usDurationMicroSec, usOffMicroSec, unRepeat, nFlags);
}
...
S_API uint16 S_CALLTYPE SteamAPI_ISteamInput_GetSessionInputConfigurationSettings(intptr_t instancePtr)
{
	...
	return GetInterfacePointers.SteamInput()->GetSessionInputConfigurationSettings();
}
...
S_API void S_CALLTYPE SteamAPI_ISteamInput_SetDualSenseTriggerEffect(intptr_t instancePtr, InputHandle_t inputHandle, const ScePadTriggerEffectParam* pParam)
{
	...
	return GetInterfacePointers.SteamInput()->SetDualSenseTriggerEffect(inputHandle, pParam);
}
...
S_API uint32 S_CALLTYPE SteamAPI_ISteamUGC_GetQueryUGCNumTags(intptr_t instancePtr, UGCQueryHandle_t handle, uint32 index)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->GetQueryUGCNumTags(handle, index);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->GetQueryUGCNumTags(handle, index);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUGC_GetQueryUGCTag(intptr_t instancePtr, UGCQueryHandle_t handle, uint32 index, uint32 indexTag, char* pchValue, uint32 cchValueSize)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->GetQueryUGCTag(handle, index, indexTag, pchValue, cchValueSize);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->GetQueryUGCTag(handle, index, indexTag, pchValue, cchValueSize);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUGC_GetQueryUGCTagDisplayName(intptr_t instancePtr, UGCQueryHandle_t handle, uint32 index, uint32 indexTag, char* pchValue, uint32 cchValueSize)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->GetQueryUGCTagDisplayName(handle, index, indexTag, pchValue, cchValueSize);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->GetQueryUGCTagDisplayName(handle, index, indexTag, pchValue, cchValueSize);
}
...
S_API uint32 S_CALLTYPE SteamAPI_ISteamUGC_GetQueryUGCContentDescriptors(intptr_t instancePtr, UGCQueryHandle_t handle, uint32 index, EUGCContentDescriptorID* pvecDescriptors, uint32 cMaxEntries)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->GetQueryUGCContentDescriptors(handle, index, pvecDescriptors, cMaxEntries);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->GetQueryUGCContentDescriptors(handle, index, pvecDescriptors, cMaxEntries);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUGC_SetTimeCreatedDateRange(intptr_t instancePtr, UGCQueryHandle_t handle, RTime32 rtStart, RTime32 rtEnd)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->SetTimeCreatedDateRange(handle, rtStart, rtEnd);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->SetTimeCreatedDateRange(handle, rtStart, rtEnd);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUGC_SetTimeUpdatedDateRange(intptr_t instancePtr, UGCQueryHandle_t handle, RTime32 rtStart, RTime32 rtEnd)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->SetTimeUpdatedDateRange(handle, rtStart, rtEnd);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->SetTimeUpdatedDateRange(handle, rtStart, rtEnd);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUGC_SetItemTags(intptr_t instancePtr, UGCUpdateHandle_t updateHandle, const struct SteamParamStringArray_t * pTags, bool bAllowAdminTags = false)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->SetItemTags(updateHandle, pTags, bAllowAdminTags);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->SetItemTags(updateHandle, pTags, bAllowAdminTags);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUGC_AddContentDescriptor(intptr_t instancePtr, UGCUpdateHandle_t handle, EUGCContentDescriptorID descid)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->AddContentDescriptor(handle, descid);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->AddContentDescriptor(handle, descid);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUGC_RemoveContentDescriptor(intptr_t instancePtr, UGCUpdateHandle_t handle, EUGCContentDescriptorID descid)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->RemoveContentDescriptor(handle, descid);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->RemoveContentDescriptor(handle, descid);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamUGC_ShowWorkshopEULA(intptr_t instancePtr)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->ShowWorkshopEULA();
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->ShowWorkshopEULA();
}
...
S_API SteamAPICall_t S_CALLTYPE SteamAPI_ISteamUGC_GetWorkshopEULAStatus(intptr_t instancePtr)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->GetWorkshopEULAStatus();
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->GetWorkshopEULAStatus();
}
...
S_API uint32 S_CALLTYPE SteamAPI_ISteamUGC_GetUserContentDescriptorPreferences(intptr_t instancePtr, EUGCContentDescriptorID* pvecDescriptors, uint32 cMaxEntries)
{
	...
	{
		if (instancePtr == (intptr_t)GetGameServerInterfacePointers.SteamUGC() || InitClientPointers == false)
			return GetGameServerInterfacePointers.SteamUGC()->GetUserContentDescriptorPreferences(pvecDescriptors, cMaxEntries);
	}

	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamUGC()->GetUserContentDescriptorPreferences(pvecDescriptors, cMaxEntries);
}
...
//Missing in SDK 1.58
/*S_API void S_CALLTYPE SteamAPI_ISteamVideo_AddTimelineHighlightMarker(intptr_t instancePtr, const char* pchIcon, const char* pchTitle, const char* pchDescription, uint32 unPriority)
{
	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamVideo()->AddTimelineHighlightMarker(pchIcon, pchTitle, pchDescription, unPriority);
}

S_API void S_CALLTYPE SteamAPI_ISteamVideo_AddTimelineTimestamp(intptr_t instancePtr, const char* pchTitle)
{
	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamVideo()->AddTimelineTimestamp(pchTitle);
}

S_API void S_CALLTYPE SteamAPI_ISteamVideo_AddTimelineRangeStart(intptr_t instancePtr, const char* pchID, const char* pchTitle)
{
	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamVideo()->AddTimelineRangeStart(pchID, pchTitle);
}

S_API void S_CALLTYPE SteamAPI_ISteamVideo_AddTimelineRangeEnd(intptr_t instancePtr, const char* pchID)
{
	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamVideo()->AddTimelineRangeEnd(pchID);
}

S_API void S_CALLTYPE SteamAPI_ISteamVideo_SetTimelineGameMode(intptr_t instancePtr, ETimelineGameMode eMode)
{
	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamVideo()->SetTimelineGameMode(eMode);
}*/
...
S_API bool S_CALLTYPE SteamAPI_ISteamRemotePlay_BStartRemotePlayTogether(intptr_t instancePtr, bool bShowOverlay)
{
	if (InitClientPointers == false)
		__debugbreak();

	return GetInterfacePointers.SteamRemotePlay()->BStartRemotePlayTogether(bShowOverlay);
}
...
S_API bool S_CALLTYPE SteamAPI_ISteamGameServer_SendUserConnectAndAuthenticate(intptr_t instancePtr, uint32 unIPClient, const void* pvAuthBlob, uint32 cubAuthBlobSize, class CSteamID* pSteamIDUser)
{
	...
	return GetGameServerInterfacePointers.SteamGameServer()->SendUserConnectAndAuthenticate_DEPRECATED(unIPClient, pvAuthBlob, cubAuthBlobSize, pSteamIDUser);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamGameServer_SendUserDisconnect_DEPRECATED(intptr_t instancePtr, class CSteamID steamIDUser)
{
	...
	return GetGameServerInterfacePointers.SteamGameServer()->SendUserDisconnect_DEPRECATED(steamIDUser);
}
...
S_API HAuthTicket S_CALLTYPE SteamAPI_ISteamGameServer_GetAuthSessionTicket(intptr_t instancePtr, void* pTicket, int cbMaxTicket, uint32* pcbTicket, const SteamNetworkingIdentity* pSnid)
{
	...
	return GetGameServerInterfacePointers.SteamGameServer()->GetAuthSessionTicket(pTicket, cbMaxTicket, pcbTicket, pSnid);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamGameServer_SetAdvertiseServerActive(intptr_t instancePtr, bool bActive)
{
	...
	return GetGameServerInterfacePointers.SteamGameServer()->SetAdvertiseServerActive(bActive);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamGameServer_SetHeartbeatInterval(intptr_t instancePtr, int iHeartbeatInterval)
{
	...
	return GetGameServerInterfacePointers.SteamGameServer()->SetMasterServerHeartbeatInterval_DEPRECATED(iHeartbeatInterval);
}
...
S_API void S_CALLTYPE SteamAPI_ISteamGameServer_ForceHeartbeat(intptr_t instancePtr)
{
	...
	return GetGameServerInterfacePointers.SteamGameServer()->ForceMasterServerHeartbeat_DEPRECATED();
}
